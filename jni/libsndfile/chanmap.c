...
static const int one_chan_mono[1] = {
    SF_CHANNEL_MAP_MONO
};
...
static const int two_channel_stereo[2] = {
...
static const int six_channel_mpeg_51_c[6] = {
    SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_REAR_LEFT,
            SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_LFE };
static const int six_channel_mpeg_51_d[6] = {
    SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_REAR_LEFT,
            SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_LFE };
static const int six_channel_audio_unit_60[6] = {
    SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_REAR_LEFT, SF_CHANNEL_MAP_REAR_RIGHT,
            SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_REAR_CENTER };
static const int six_channel_aac_60[6] = {
    SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_REAR_LEFT,
            SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_REAR_CENTER };
...
static const int six_channel_mpeg_61a[7] = {
        SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_LFE,
        SF_CHANNEL_MAP_REAR_LEFT, SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_REAR_CENTER };
static const int six_channel_aac_61[7] = {
        SF_CHANNEL_MAP_CENTER, SF_CHANNEL_MAP_LEFT, SF_CHANNEL_MAP_RIGHT, SF_CHANNEL_MAP_REAR_LEFT,
        SF_CHANNEL_MAP_REAR_RIGHT, SF_CHANNEL_MAP_REAR_CENTER, SF_CHANNEL_MAP_LFE };
...
static const AIFF_CAF_CHANNEL_MAP eight_chan[] = {
    ...
    { (111 << 16) | 8, NULL, "octagonal (Lf, Rf, Lr, Rr, Cf, Cr, Ls, Rs)" },
    // left, right, rear left, rear right
    // top left, top right, top rear left, top rear right
    { (112 << 16) | 8, NULL, "cube (L, R, Lrear, Rrear, Ltop, Rtop, Ltoprear, Rtoprear)" },
    ...
    { (130 << 16) | 8, NULL, "SMPTE DTV (L, R, C, LFE, Ls, Rs, Lt, Rt)" },
...
int aiff_caf_find_channel_layout_tag(const int *chan_map, int channels) {
    ...
    for (k = 0; k < len; k++)
        if (curr_map[k].channel_map != NULL)
            if (memcmp(chan_map, curr_map[k].channel_map,
                        channels * sizeof(chan_map[0])) == 0)
