...
static void Weighting_filter(register word * e, /* signal [-5..0.39.44]	IN  */
...
#define STEP( i, H ) (e[ k + i ] * (longword)H)
        ...
        x[k] = (L_result < MIN_WORD ?
                MIN_WORD : (L_result > MAX_WORD ? MAX_WORD : L_result));
    }
}

/* 4.2.14 */
static void RPE_grid_selection(word * x, /* [0..39] IN */
                word * xM, /* [0..12] OUT */
                word * Mc_out) { /* OUT */
/*
...
static void APCM_quantization_xmaxc_to_exp_mant(word xmaxc, /* IN */
                word * expon_out, /* OUT */
                word * mant_out) { /* OUT */
...
static void APCM_quantization(word * xM, /* [0..12] IN */
                word * xMc, /* [0..12] OUT */
                word * mant_out, /* OUT */
                word * expon_out, /* OUT */
                word * xmaxc_out) { /* OUT */
    ...
    assert(mant >= 0 && mant <= 7);
    temp1 = 6 - expon; /* normalization by the exponent */
...
/* 4.2.16 */
static void APCM_inverse_quantization(register word * xMc, /* [0..12] IN */
                word mant, word expon,
...
/* 4.2.17 */
static void RPE_grid_positioning(word Mc, /* grid position IN */
...
void Gsm_RPE_Decoding(
                /*-struct gsm_state	* S,-*/
                word xmaxcr,
                word Mcr, word * xMcr, /* [0..12], 3 bits IN */
                word * erp) { /* [0..39] OUT */
    word expon, mant;
    word xMp[13];
