...
static int gen_coding_history(char * added_history,
            int added_history_max, const SF_INFO * psfinfo);
...
int broadcast_var_set(SF_PRIVATE *psf, const SF_BROADCAST_INFO * info,
    ...
    psf_strlcpy_crlf(psf->broadcast_16k->coding_history, info->coding_history,
                     ...
                     datasize - offsetof(SF_BROADCAST_INFO, coding_history));
...
int broadcast_var_get(SF_PRIVATE *psf, SF_BROADCAST_INFO * data,
    ...
    size = SF_MIN (datasize, bc_min_size ((const SF_BROADCAST_INFO *)
                    psf->broadcast_16k));
