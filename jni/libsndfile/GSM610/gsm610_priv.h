...
static inline longword GSM_MULT_R (word a, word b) {
    return (((longword) (a)) * ((longword) (b)) + 16384) >> 15;
} /* GSM_MULT_R */

static inline longword GSM_MULT (word a, word b) {
...
static inline longword GSM_L_ADD (longword a, longword b) {
    ulongword utmp;
...
static inline longword GSM_ADD (word a, word b) {
    longword ltmp;
...
static inline longword GSM_SUB (word a, word b) {
    longword ltmp;
    ltmp = ((longword) a) - ((longword) b);
